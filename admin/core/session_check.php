  ...
  <section id="content" class="m-t-lg wrapper-md animated fadeInUp">    
    <div class="container aside-xl">
       <section class="m-b-lg" style="margin-top: 30px;">
        ...
        <div style="text-align: center;"><a dclass="navbar-brand block" href="#" style="color: white; font-size: 25px; ">ADMIN LOGIN</a>
     </div>
        <div style="text-align: center; margin-top: 20px; font-size: 16px; color: red;"><br><br></div>
       <form action="#" id="#admin-form" method="post">
          <div class="list-group">
            
            <div class="list-group-item">
              <input type="email" name="email" placeholder="Email" id="email"  class="form-control no-border">
            </div>
            <div class="list-group-item">
               <input type="password" placeholder="Password" id="password" name="password" class="form-control no-border">
            </div>
          </div>
          <button type="submit" id="admin-btn" class="btn btn-lg btn-primary btn-block">LOGIN</button>
         <br><br>
