...
if (isset($_POST['action']) && $_POST['action'] == "activateUser") {
    // print_r($_POST);
    $id = $_POST['id'];
    $activae = activateUser($conn, $id);
    echo "success";
}

if (isset($_POST['action']) && $_POST['action'] == "deactivateUser") {
    // print_r($_POST);
    $id = $_POST['id'];
    $activae = deactivateAUser($conn, $id);
    echo "success";
}
...
if (isset($_POST['disapproveId'])) {
    ...
    $disapprove = disapprovePayement($conn, $id, $date_t);
    if ($disapprove) {
        echo "success";
    } else {
        echo "fail";
...
if (isset($_POST['action']) && $_POST['action'] == "Add_new_investment") {
    // print_r($_POST);
    $userId = $_POST['userId'];
    $rate = $_POST['rate'];
    $amount = $_POST['amount'];
