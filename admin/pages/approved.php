...
?>
 ...
 <th style="border:solid; border-width: thin; border-color: #eee; color: white; background-color: #0060a0;">Request Date</th>
...
//   print_r((fetchUserWallet($conn,$userId)['balance']));
  ...
  <tr>
    ...
    <td style="border:solid; border-width: thin; border-color: #eee;"><?php echo date('d-M-Y',strtotime('+0 days',strtotime(str_replace('/', '-', $row['approvedDate'])))); ?></td>
  </td>
